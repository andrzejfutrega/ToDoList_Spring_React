...
function App() {
  ...
  const filteredTasks = tasks.filter((task) => task.name.toLowerCase().includes(search.toLowerCase()))
    .sort((a, b) => {
      if (a.checked === b.checked) return 0; return a.checked ? 1 : -1;
    });
  ...
  return (
    <>
        ...
        <Toolbar>
          ...
          <Box display="flex" justifyContent="center" alignItems="center" sx={{ marginLeft: 'auto', marginRight: 2 }}>
            ...
            <TextField
              ...
              autoComplete='off'
              sx={{
                minWidth: 100, "& .MuiOutlinedInput-root": {
                  "& fieldset": {
                    borderColor: "white",
                  },
                  "&:hover fieldset": {
      ...
      <Box display="flex" flexDirection="column" alignItems="center" sx={{
        position: 'fixed', marginTop: 16, top: 0, left: "50%",
        ...
        <TextField
          ...
          sx={{
            marginBottom: 2, marginTop: 2, minWidth: 100, "& .MuiOutlinedInput-root": {
      ...
      <List sx={{
        position: 'fixed', top: 0, left: "50%", transform: "translateX(-50%)", marginTop: 35, overflow: 'auto',
        ...
        {filteredTasks.map((task) => (
          ...
          >
            <Checkbox
              ...
              sx={{
                marginRight: '12px', color: "whitesmoke", '&.Mui-checked': {
                  color: 'whitesmoke'
                },
              }}
            />
